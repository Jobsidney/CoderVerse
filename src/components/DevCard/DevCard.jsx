...
function Devcard({data}) {
  return (
	<div className='mx-[500px] mt-4 flex flex-col space-y-9 '>
		...
		<div className='flex justify-between border-b-2  border-amber-400 pb-3 ' >
        ...
        <div className='flex flex-col space-y-4 border-r-2  border-slate-500 pr-6'>
        <div className=''>
